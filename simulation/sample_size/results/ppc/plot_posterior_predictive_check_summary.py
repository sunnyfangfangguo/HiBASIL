...
for size in sample_sizes:
    ...
    grouped_df.to_csv(f'{output_dir}posterior_predictive_performace_metrics_summary_unknown_{size}.csv')
...
for model_type in models_to_test:
    ...
    plt.tight_layout()
    plt.savefig(f'{output_dir}{model_type}_sample_sizes_posterior_predictive_check.png',
