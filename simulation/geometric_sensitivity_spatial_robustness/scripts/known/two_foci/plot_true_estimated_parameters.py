...
for model_type in model_types:
    ...
    if model_type == "power_law":
        true_values_dict = {'scale1':5.0, 'exponent1':2.0, 'scale2':5.0, 'exponent2':2.0, 
                            'weight':0.6, 'q_param':0.01, 'pi0':0.3, 'phi':18, 'p_param':0.3, 'mu':0.2}
    elif model_type in ['exponential', 'gaussian']:
        true_values_dict = {'scale1':5.0, 'scale2':5.0, 'weight':0.6, 'q_param':0.01, 'pi0':0.3, 
