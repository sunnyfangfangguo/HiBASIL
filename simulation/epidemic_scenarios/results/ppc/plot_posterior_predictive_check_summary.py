...
scenarios = ['base', 'narrowsteep', 'widesteep', 'wideshallow']


for scenario in scenarios:
    metrics_df = pd.read_csv(f'{output_dir}ppc_metrics_all_sims_unknown_{scenario}.csv')
    ...
    grouped_df.to_csv(f'{output_dir}posterior_predictive_performace_metrics_summary_unknown_{scenario}.csv')
...
for model_type in models_to_test:
    ...
    plt.tight_layout()
    plt.savefig(f'{output_dir}{model_type}_dispersal_scenarios_posterior_predictive_check.png',
