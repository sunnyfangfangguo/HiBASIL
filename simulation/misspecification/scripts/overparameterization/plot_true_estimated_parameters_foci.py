...
for model_type in model_types:
    # Because the real data only has one focus, so the weight is 0, and the bias actually was compared to focus 1 two times
    if model_type == "power_law":
        true_values_dict = {'fx1':0, 'fy1':0, 'fz1':0.6, 'fx2':0, 'fy2':0, 'fz2':0.6, 'scale1':5.0, 
                            'exponent1':2.0, 'scale2':5.0, 'exponent2':2.0, 
                            'weight':1.0, 'q_param':0.01, 'pi0':0.3, 
                        'phi':18, 'p_param':0.3, 'mu':0.2}
    elif model_type in ['exponential', 'gaussian']:
        true_values_dict = {'fx1':0, 'fy1':0, 'fz1':0.6, 'fx2':0, 'fy2':0, 'fz2':0.6, 'scale1':5.0, 
                            'scale2':5.0, 'weight':1.0, 'q_param':0.01, 'pi0':0.3, 
                        'phi':18, 'p_param':0.3, 'mu':0.2}
