...
for mixture in mixtures:
    metrics_df = pd.read_csv(f'{output_dir}ppc_metrics_all_sims_unknown_{mixture}.csv')
    ...
    grouped_df.to_csv(f'{output_dir}posterior_predictive_performace_metrics_summary_unknown_{mixture}.csv')
...
for model_type in models_to_test:
    ...
    plt.tight_layout()
    plt.savefig(f'{output_dir}{model_type}_foci_imbalance_posterior_predictive_check.png',
