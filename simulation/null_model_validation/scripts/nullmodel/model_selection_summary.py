...
model_types = ['null_model', 'exponential', 'gaussian', 'power_law']
...
for sim in range(n_sims):
    ...
    for model_type in model_types:
        likelihood = performance_df.at['log_likelihood', model_type]
...
model_select_df = pd.DataFrame({'Simulation':sims, 'Model':models, 'likelihood':likelihoods, 'rank_loo':rank_loos,
