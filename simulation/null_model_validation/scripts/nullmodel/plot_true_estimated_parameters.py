...
def extract_metrics(df, sim, model_type, true_values_dict):
    ...
    if model_type == 'power_law':
        global_params = ['scale1', 'exponent1', 'q_param', 'pi0', 'phi', 'p_param']
        
    elif model_type in ['exponential', 'gaussian']:
        global_params = ['scale1', 'q_param', 'pi0', 'phi', 'p_param']
                
    elif model_type == 'null_model':
        global_params = ['q_param', 'pi0', 'phi', 'p_param']
...
for model_type in model_types:
    ...
    if model_type == "power_law":
        true_values_dict = {'scale1':5.0, 'exponent1':2.0, 'q_param':0.01, 'pi0':0.5, 
                        'phi':18, 'p_param':0.5, 'mu':0.2}
    elif model_type in ['exponential', 'gaussian']:
        true_values_dict = {'scale1':5.0, 'q_param':0.01, 'pi0':0.5, 
                        'phi':18, 'p_param':0.5, 'mu':0.2}
        
    elif model_type == 'null_model':
        true_values_dict = {'q_param':0.01, 'pi0':0.5, 
                        'phi':18, 'p_param':0.5, 'mu':0.2}
