...
est_params_dict = {'model_type':model_type_list, 'simulation':sim_list, 'scale1_mean':scale1_mean_list,
                   ...
                   "exponent1_mean":exponent1_mean_list, "exponent1_hdi25":exponent1_hdi25_list, 
                   "exponent1_hdi975":exponent1_hdi975_list}

est_params_df = pd.DataFrame(data=est_params_dict)
est_params_df.to_csv("./output/estimated_parameter_mean_hdi_onefocus.csv")
